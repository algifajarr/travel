...
<head>
	...
	<!-- /fonts -->
	<!-- css -->
	<link href="gudang/ticketo/css/bootstrap.css" rel="stylesheet" type='text/css' media="all" />
	<link href="gudang/ticketo/css/style.css" rel="stylesheet" type='text/css' media="all" />
	<!-- /css -->
</head>
...
<body>
	...
	<!-- js -->
	<script src="gudang/ticketo/js/jquery-2.1.4.min.js"></script>
	<!-- //js -->

	<script src="gudang/ticketo/js/bootstrap.min.js"></script>
	<script src="gudang/ticketo/js/validator.min.js"></script>
	<!-- /js files -->
</body>
