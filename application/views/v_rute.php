  ...
  <div>
    ...
    <li class="dropdown user user-menu">
      <a href="#" class="dropdown-toggle" data-toggle="dropdown">
        ...
        <span class="hidden-xs">algifajarr</span>
      </a>
      <ul class="dropdown-menu">
        <!-- User image -->
      ...
      <div class="row">
            ...
            <div class="box-body">
              <form action="<?php echo base_url('admin/proses_tambah'); ?>" method="post">
                <div class="form-group">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control timepicker" id="datepicker" name="depart" required="true" readonly="true">
                  </div>
                </div>
                <div class="form-group">
        ...
        <div class="col-md-8">
          <section>
           ...
           <tbody>
            <?php
            foreach($rute_data as $rutes)
              {?>
               <tr>
                <td><?php echo $rutes->depart_at ?></td>
                <td><?php echo $rutes->rute_from ?></td>
                <td><?php echo $rutes->rute_to?></td>
                <td><?php echo $rutes->arrival ?></td>
                <td><?php echo $rutes->price ?></td>
                <td><?php echo $rutes->id_transportation?></td>
                <td>
                  <button class="btn btn-warning" onclick="ngedit_user(<?php echo $rutes->id_rute;?>)">Edit</button>
                 <button class="btn btn-danger" onclick="ngapus_rute(<?php echo $rutes->id_rute;?>)">Hapus</button>
               </td>
             </tr>
             <?php } ?>
           </tbody>
