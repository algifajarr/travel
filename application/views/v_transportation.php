      ...
      <div class="row">
        <div class="col-md-6">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body">
              <form action="<?php echo base_url('admin/add_transportation'); ?>" method="post">
          ...
          foreach($transportation_data as $trans)
            {?>
             <tr>
              ...
              <td><?php echo $trans->seat_qty ?></td>
              <td>
               <button class="btn btn-warning" onclick="ngedit_user(<?php echo $trans->id_transportation;?>)">Edit</button>
               <button class="btn btn-danger" onclick="ngapus_rute(<?php echo $trans->id_transportation;?>)">Hapus</button>
             </td>
           </tr>
           <?php } ?>
         </tbody>
