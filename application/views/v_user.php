          ...
          foreach($user as $tuser)
            {?>
             <tr>
              ...
              <td>
               <button class="btn btn-warning" onclick="ngedit_user(<?php echo $tuser->id_user;?>)">Edit</button>
               <button class="btn btn-danger" onclick="ngapus_rute(<?php echo $tuser->id_user;?>)">Hapus</button>
             </td>
           </tr>
           <?php } ?>
         </tbody>
